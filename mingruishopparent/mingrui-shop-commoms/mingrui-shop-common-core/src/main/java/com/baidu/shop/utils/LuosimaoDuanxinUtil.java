...
public class LuosimaoDuanxinUtil {
    //短信平台的APIkey
    private static final String DUANXIN_API_KEY = "key-eea1a3c5b219b923b63ef5ae4f3d82dd";//需要使用自己的APIkey
    private static final String SPEAK_API_KEY = "key-9fe88476343148db96289501988cadbe";//需要使用自己的APIkey
